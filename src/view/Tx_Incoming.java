 ...
 * @author rafii
 */
public class Tx_Incoming extends javax.swing.JPanel {

    /**
     * Creates new form Mst_Item
     */
    private Service_Incoming serviceIn = (Service_Incoming) new DAO_Incoming();
    private Service_Detail_Incoming serviceDetIn = (Service_Detail_Incoming) new DAO_Detail_Incoming();
    private Service_Item serviceItem = (Service_Item) new DAO_Item();
    private Service_Cart_Incoming serviceCartIn = (Service_Cart_Incoming) new DAO_Cart_Incoming();
    
    private TabMod_Incoming tblModIn = new TabMod_Incoming();
    private TabMod_Detail_Incoming tblModDetIn = new TabMod_Detail_Incoming();
    private TabMod_Cart_Incoming tblModCartIn = new TabMod_Cart_Incoming();
    
    private final int noColumnIndex = 0;
    private final int noColumnWidth = 50;
    private final String id;
    public Tx_Incoming(String id) {
        initComponents();
        setupSubtotalUpdater();
        ((AbstractDocument) tfQuantity.getDocument()).setDocumentFilter(new NumericDocumentFilter());
        tbl_in.setModel(tblModIn);
        tbl_detail.setModel(tblModDetIn);
        tblCart.setModel(tblModCartIn);
        loadData();
    ...
    private void initComponents() {
        ...
        dataIncoming = new javax.swing.JPanel();
        ...
        addIncoming = new javax.swing.JPanel();
        ...
        dataIncoming.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setText("Transaction Incoming");
        ...
        tbl_in.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tbl_in.setGridColor(new java.awt.Color(255, 255, 255));
        tbl_in.getTableHeader().setReorderingAllowed(false);
        tbl_in.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tbl_inFocusGained(evt);
            }
        ...
        javax.swing.GroupLayout dataIncomingLayout = new javax.swing.GroupLayout(dataIncoming);
        dataIncoming.setLayout(dataIncomingLayout);
        dataIncomingLayout.setHorizontalGroup(
            dataIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnDetail, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(dataIncomingLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(dataIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dataIncomingLayout.createSequentialGroup()
                        .addGroup(dataIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        dataIncomingLayout.setVerticalGroup(
            dataIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, dataIncomingLayout.createSequentialGroup()
        ...
        mainPanel.add(dataIncoming, "card2");

        addIncoming.setBackground(new java.awt.Color(255, 255, 255));
        ...
        titleProject.setText("Add Incoming");
        ...
        jLabel15.setText("Distributor Name");

        jLabel27.setForeground(new java.awt.Color(255, 255, 255));
        jLabel27.setText("ID Distributor");
        ...
        tfPrice.setText("jTextField12");
        tfPrice.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 5, new java.awt.Color(255, 0, 51)));
        tfPrice.setEnabled(false);
        jPanel2.add(tfPrice);

        tfSubtotal.setText("jTextField12");
        tfSubtotal.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 5, 0, 0, new java.awt.Color(255, 0, 51)));
        tfSubtotal.setEnabled(false);
        jPanel2.add(tfSubtotal);
        ...
        jLabel25.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 5, new java.awt.Color(255, 0, 51)));
        jPanel14.add(jLabel25);

        jLabel26.setForeground(new java.awt.Color(255, 255, 255));
        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel26.setText("Subtotal");
        jLabel26.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 5, 0, 0, new java.awt.Color(255, 0, 51)));
        ...
        javax.swing.GroupLayout addIncomingLayout = new javax.swing.GroupLayout(addIncoming);
        addIncoming.setLayout(addIncomingLayout);
        addIncomingLayout.setHorizontalGroup(
            addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(addIncomingLayout.createSequentialGroup()
                .addGroup(addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(addIncomingLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(addIncomingLayout.createSequentialGroup()
                ...
                .addGroup(addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(addIncomingLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(addIncomingLayout.createSequentialGroup()
                                .addGap(0, 271, Short.MAX_VALUE)
                                .addGroup(addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, addIncomingLayout.createSequentialGroup()
                                        .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(tfTotalPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        addIncomingLayout.setVerticalGroup(
            addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, addIncomingLayout.createSequentialGroup()
                .addGroup(addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, addIncomingLayout.createSequentialGroup()
                    ...
                    .addGroup(addIncomingLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(addIncomingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        mainPanel.add(addIncoming, "card2");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        mainPanel.add(dataIncoming);
        mainPanel.repaint();
        mainPanel.revalidate();
        serviceCartIn.delCart();
    ...
    private void saveAddProjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveAddProjectActionPerformed
       if(titleProject.getText().equals("Add Incoming")){
            saveData();
       }else if(titleProject.getText().equals("Edit Incoming")){
//            updateData();
       }
    ...
    private void tbl_inMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_inMouseClicked
        ...
        String id = tbl_in.getValueAt(row,0).toString();
        pnDetail.setVisible(true);  
        List<Model_Detail_Incoming> list = serviceDetIn.getData(id);
        tblModDetIn.setData(list);
        delBtn.setVisible(true);
    }//GEN-LAST:event_tbl_inMouseClicked

    private void tbl_inFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tbl_inFocusLost

    }//GEN-LAST:event_tbl_inFocusLost

    private void tbl_inFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tbl_inFocusGained
        delBtn.setEnabled(true);
        updBtn.setEnabled(true);
    }//GEN-LAST:event_tbl_inFocusGained
...
//        getDataTable();
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        serviceDetIn.sumTotal(mdi);
        tfTotalPrice.setText(mdi.getTotal_price());
        loadDataCartIn();
        bUpdCart.setEnabled(false);
        bDelCart.setEnabled(false);
    ...
    private void bItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bItemActionPerformed
        ...
        Data_Item_incoming datItem = new Data_Item_incoming(null, true,id);
        bUpdCart.setEnabled(false);
        bDelCart.setEnabled(false);
        ...
        public void windowClosed(java.awt.event.WindowEvent e) {
            ...
            if (datItem.model.getItems_name() != null && !datItem.model.getItems_name().isEmpty()) {
                ...
                tfPrice.setText(datItem.model.getPrice());
                tfUnit.setText(datItem.model.getUnit());
                tfBrand.setText(datItem.model.getBrand());
                tfQuantity.setText("1");
                tfSubtotal.setText(datItem.model.getPrice());
            }
//            bItem.requestFocus();
        }
    });
    ...
    private void bDistributorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDistributorActionPerformed
     Data_Distributor datDis = new Data_Distributor(null, true);
        datDis.addWindowListener(new java.awt.event.WindowAdapter() {
        @Override
        public void windowClosed(java.awt.event.WindowEvent e) {
            // Kode ini akan dijalankan setelah dialog ditutup dan di-dispose
            if (datDis.model.getDistributor_name() != null && !datDis.model.getDistributor_name().isEmpty()) {
                tfIdDistributor.setText(datDis.model.getId_distributor());
                tfDistributorName.setText(datDis.model.getDistributor_name());
                resetFormItem();
    ...
    private void tblCartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCartMouseClicked
        ...
        tfPrice.setText(tblCart.getModel().getValueAt(row, 7).toString());
        tfBrand.setText(tblCart.getModel().getValueAt(row, 8).toString());
        tfSubtotal.setText(tblCart.getModel().getValueAt(row, 9).toString());
    ...
    private void bDelCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDelCartActionPerformed
        ...
        if(index!=-1){
            Model_Cart_Incoming mci = tblModCartIn.getData(tblCart.convertRowIndexToModel(index));
            if(JOptionPane.showConfirmDialog(null,"Delete this Data?","Warning",JOptionPane.OK_CANCEL_OPTION)==JOptionPane.OK_OPTION){
                serviceCartIn.deleteData(tblCart.getModel().getValueAt(index, 1).toString());
                tblModCartIn.deleteData(index);
                List<Model_Cart_Incoming> list = serviceCartIn.getData();
                tblModCartIn.setData(list);
                resetFormItem();
                bDelCart.setEnabled(false);
                bUpdCart.setEnabled(false);
                bAddCart.setEnabled(true);
    ...
    private void addToCart(){
        if(inputValidation()){
            ...
            min.setId_incoming(idIncoming);
            mdi.setMoin(min);
            md.setId_distributor(idDis);
            md.setDistributor_name(disName);
    ...
    private void saveData() {
        ...
        if(tblCart.getRowCount()!=0){
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                String brand            = model.getValueAt(i, 8).toString();
                String subtotal         = model.getValueAt(i, 9).toString();

                min.setId_incoming(idIncoming);
                min.setTransaction_date(date);
                min.setTotal_price(totalPrice);
            ...
            serviceIn.addData(mci);
            loadData();
            serviceCartIn.delCart();
            JOptionPane.showMessageDialog(null,"Success to add incoming");
            mainPanel.removeAll();
            mainPanel.repaint();
            mainPanel.revalidate();
            mainPanel.add(dataIncoming);
    ...
    private javax.swing.JPanel addIncoming;
    ...
    private javax.swing.JPanel dataIncoming;
    ...
    private void loadData() {
        ...
        List<Model_Incoming> list = serviceIn.getData();
        tblModIn.setData(list);
    ...
    private void showPanel() {
        mainPanel.removeAll();
        mainPanel.add(new Tx_Incoming(id));
        mainPanel.repaint();
        mainPanel.revalidate();
    }
...
//    }
    ...
    private void delData() {
        int index = tbl_in.getSelectedRow();
        if(index!=-1){
            Model_Incoming modIn = tblModIn.getData(tbl_in.convertRowIndexToModel(index));
            if(JOptionPane.showConfirmDialog(null,"Delete this Data?","Warning",JOptionPane.OK_CANCEL_OPTION)==JOptionPane.OK_OPTION){
                serviceIn.delData(modIn);
                tblModIn.deleteData(index);
                loadData();
                resetForm();  
            }
        }else{
    ...
    private void showData() {
        tfNoIncoming.setText(generateSmartId("IN"));
...
//            Model_Project modPro = tblMod.getData(dataProjectTable.convertRowIndexToModel(index));
            ...
            mci.setMoit(mi);
            mci.setMoty(mt);
                serviceCartIn.updCart(mci);
                tblModCartIn.updateData(index, mci);
                serviceDetIn.sumTotal(mdi);
                tfTotalPrice.setText(mdi.getTotal_price());
                loadDataCartIn();
                bAddCart.setEnabled(true);
...
//        updBtn.setVisible(false);
    ...
    tfPrice.getDocument().addDocumentListener(listener);
}
...
private void updateSubtotal() {
    ...
    if (!qtyText.isEmpty() && !priceText.isEmpty()) {
        try {
            ...
            tfSubtotal.setText(String.valueOf(qty * price));
        } catch (NumberFormatException e) {
            tfSubtotal.setText("0");
        }
    } else {
        tfSubtotal.setText("0"); // jika salah satu kosong
    }
}
