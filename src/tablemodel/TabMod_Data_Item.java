 ...
 * @author rafii
 */
public class TabMod_Data_Item extends AbstractTableModel{
    ...
    private final String[] colName={" No","  Id Items" ,"  Type" ,"  Item Name","  Unit","  Stock","  Price","  Brand"};
    @Override
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 4: return list.get(rowIndex).getUnit();
            case 5: return list.get(rowIndex).getStock();
            case 6: return list.get(rowIndex).getPrice();
            case 7: return list.get(rowIndex).getBrand();
