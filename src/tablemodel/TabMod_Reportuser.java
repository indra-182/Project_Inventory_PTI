 ...
 * @author adam
 */
public class TabMod_Reportuser extends AbstractTableModel {
...
public void addData(Model_User mk){
    ...
    private final String[] colName={" No","  Nama Karyawan ","  Group","  Username" ,"Last Active"};
    @Override
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 4: return list.get(rowIndex).getLast_login();
